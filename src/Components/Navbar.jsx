          ...
          {user ? (
            <div className="flex flex-col-reverse md:flex-row items-center gap-2">
              ...
              <button
                ...
                className="w-[100px] h-[40px] bg-white  text-black font-bold border border-black text-bold rounded hover:bg-slate-600 hover:text-white"
              >
                Sign Out
              </button>
            </div>
            ...
            <Link to="/login">
              <button className="w-[100px] h-[40px] bg-white font-bold text-black text-bold rounded hover:bg-slate-600 hover:text-white">
                Login
              </button>
            </Link>
          )}
